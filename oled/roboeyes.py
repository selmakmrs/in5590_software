...
class FBUtil:
    ...
    def fill_rrect(self, *args, **kwargs):pass
    def fill_triangle(self, *args, **kwargs):pass
...
class StepData:
	__slots__ = [ "owner_seq", "done", "ms_timing", "_lambda" ]
...
class Sequences( list ):
	...
	def get(self, name):
		# Return a spestfic sequence
		if name in self._map:
			return self._map.get(name)
		return None

class RoboEyes():
	def __init__(self, fb, width, height, frame_rate=12, on_show=None, bgcolor=BGCOLOR, fgcolor=FGCOLOR ):
		...
		self.gfx = fb  # Extra drawing methods 
