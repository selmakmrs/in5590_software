...
import time
from ssd_shim_dual import LumaSSD1306Shim
...
robo = RoboEyes(lcd, 128, 48, frame_rate=60, on_show=lcd.on_show)
robo.eyes_width(40,40)
robo.eyes_height(30,30)
robo.eyes_radius(6,6)
...
while True:
    ...
    robo.update()
    if robo.sequences.get("happy").done:
        seq = robo.sequences.get("demo")
        seq.start()
        print("Startting Demo")
